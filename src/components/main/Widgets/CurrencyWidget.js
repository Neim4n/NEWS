    ...
    return (
        <div className="exchange__widget">
            ...
            <div className="widget__items">
                ...
                <WidgetItem data={data.currencies.find(elem => elem.label === "USD")}/>
                <WidgetItem data={data.currencies.find(elem => elem.label === "RUB")}/>
                <WidgetItem data={data.currencies.find(elem => elem.label === "UAH")}/>
            </div>
